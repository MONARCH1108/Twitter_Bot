...
class NewsProcessor:
    ...
    def __init__(self, gemini_api_key: str, ollama_base_url: str = "http://localhost:11434"):
        """
...
def main():
    ...
    GEMINI_API_KEY = "_API_KEY_"  # Replace with your actual Gemini API key
    JSON_FILE_PATH = r"_Path_"  # Path to your JSON file
